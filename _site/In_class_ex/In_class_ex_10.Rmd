...
description: |
  In this in class ex 10, we will explore finance data.
...
Extract daily values of the stocks
...
Left Joincompay dataframe with Stock_daily
...
Using geom_vline() to add reference line
...
Step 1: Selecting the f stocks of interest
...
## Plotting candlestick with moving avg
